...
export default function ComprasPage() {
  ...
  if (!lista) return (
    <div style={{ textAlign: 'center', padding: 60 }}>
      <h2 style={{ color: 'var(--text2)' }}>Nenhuma lista disponivel</h2>
      <p className="text-muted mt-8">A lista e gerada automaticamente quando seu protocolo de dieta for enviado.</p>
    </div>
  )
    ...
    <>
      <div className="dash-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 12 }}>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          ...
          <button className="btn btn-primary btn-sm" onClick={exportPDF}>Baixar PDF</button>
        </div>
      </div>
