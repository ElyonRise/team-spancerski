  ...
  return (
    ...
    <>
      ...
      <div className="dash-header">
        ...
        <h1>OLÁ, {session?.name?.toUpperCase().split(' ')[0]}! 💪</h1>

        <p>Bem-vindo(a) de volta. Aqui está seu resumo.</p>

      </div>

      <div className="stats-grid">

        <div className="stat-card"><div style={{ fontSize: '1.6rem' }}>🔥</div><div className="num">{streak}</div><div className="lbl">dias de streak</div></div>

        <div className="stat-card"><div style={{ fontSize: '1.6rem' }}>📊</div><div className="num">{imc ? imc.imc : '—'}</div><div className="lbl">IMC atual</div></div>

        <div className="stat-card"><div style={{ fontSize: '1.6rem' }}>🥗</div><div className="num">{dieta ? '✓' : '—'}</div><div className="lbl">{dieta ? 'dieta ativa' : 'sem dieta'}</div></div>
      ...
      <div className="card mt-24">
        ...
        <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginTop: 4 }}>
          ...
          <Link href="/dashboard/ia" className="btn btn-primary btn-sm">🤖 Falar com IA</Link>
          ...
          <Link href="/dashboard/motivacao" className="btn btn-purple btn-sm">🔥 Motivação</Link>
