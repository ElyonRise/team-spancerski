...
export default function ConfiguracoesPage() {
  ...
  async function changePass(e: React.FormEvent) {
    e.preventDefault()
    if (senhas.new !== senhas.confirm) { showAlert('error', 'As senhas nao coincidem.'); return }
    if (senhas.new.length < 6) { showAlert('error', 'Minimo 6 caracteres.'); return }
    setLoading(true)
  ...
  return (
    <>
      <div className="dash-header"><h1>CONFIGURACOES</h1></div>
