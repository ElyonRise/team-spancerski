...
export default function ClientesPage() {
  ...
  async function remover(id: number, name: string) {
    ...
    if (!confirm(`Remover cliente ${name}? Esta ação é irreversível.`)) return
        ...
        {clientes.length === 0 ? (
          ...
          <div className="table-wrap">
            ...
            <table>
              ...
              <thead><tr><th>Nome</th><th>Email</th><th>Objetivo</th><th>Dietas</th><th>Streak</th><th>Cadastro</th><th>Ações</th></tr></thead>
                  ...
                  <tr key={c.id}>
                    ...
                    <td>
                      ...
                      <div style={{ display: 'flex', gap: 6 }}>
                        ...
                        <Link href={`/pro/enviar-dieta?client=${c.id}`} className="btn btn-outline btn-sm">🥗</Link>

                        <button onClick={() => remover(c.id, c.name)} className="btn btn-danger btn-sm">🗑</button>
