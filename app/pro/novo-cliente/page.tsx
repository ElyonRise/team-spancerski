    ...
    <>
      ...
      <div className="card" style={{ maxWidth: 500 }}>
        ...
        <div style={{ background: 'var(--dark3)', borderRadius: 12, padding: 20, border: '1px solid var(--border)' }}>
          ...
          <p><span style={{ color: 'var(--text2)' }}>Senha temporária: </span><strong style={{ color: 'var(--green)', fontSize: '1.1rem' }}>{success.pass}</strong></p>

        </div>

        <p className="text-muted text-sm" style={{ marginTop: 12 }}>⚠️ O cliente deverá redefinir a senha após o primeiro acesso.</p>
    ...
    <>
      ...
      <div className="card" style={{ maxWidth: 520 }}>
        ...
        <div className="alert alert-info" style={{ marginBottom: 20 }}>
          ...
          📧 Após cadastro, o email com login e senha temporária será enviado automaticamente ao cliente.
